...
package org.covito.kit.file.fastdfs;

import java.io.IOException;

import org.covito.kit.file.fastdfs.common.FastdfsException;
import org.covito.kit.file.fastdfs.common.NameValuePair;
...
public class StorageClient1 extends StorageClient {
	...
	public String upload_file1(String local_filename, String file_ext_name,
		...
		String parts[] = this.upload_file(local_filename, file_ext_name,
				meta_list);
		if (parts != null) {
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
					+ parts[1];
		} else {
			return null;
		}
	 ...
	 *         return null if fail
	 */
	public String upload_file1(String group_name, String local_filename,
			String file_ext_name, NameValuePair[] meta_list)
			throws IOException, FastdfsException {
		String parts[] = this.upload_file(group_name, local_filename,
	 ...
	 *         return null if fail
	 */
	public String upload_file1(String group_name, byte[] file_buff,
			String file_ext_name, NameValuePair[] meta_list)
			throws IOException, FastdfsException {
		String parts[] = this.upload_file(group_name, file_buff, file_ext_name,
				meta_list);
		if (parts != null) {
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
					+ parts[1];
	...
	public String upload_file1(String group_name, long file_size,
			...
			NameValuePair[] meta_list) throws IOException, FastdfsException {
		String parts[] = this.upload_file(group_name, file_size, callback,
				file_ext_name, meta_list);
		if (parts != null) {
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
					+ parts[1];
	...
	public String upload_appender_file1(String local_filename,
			String file_ext_name, NameValuePair[] meta_list)
			throws IOException, FastdfsException {
		String parts[] = this.upload_appender_file(local_filename,
				file_ext_name, meta_list);
		if (parts != null) {
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
					+ parts[1];
	...
	public String upload_appender_file1(String group_name,
			...
			NameValuePair[] meta_list) throws IOException, FastdfsException {
		String parts[] = this.upload_appender_file(group_name, local_filename,
				file_ext_name, meta_list);
		if (parts != null) {
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
					+ parts[1];
	...
	public String upload_appender_file1(byte[] file_buff, String file_ext_name,
			NameValuePair[] meta_list) throws IOException, FastdfsException {
		String parts[] = this.upload_appender_file(file_buff, file_ext_name,
				meta_list);
		if (parts != null) {
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
					+ parts[1];
	 ...
	 *         return null if fail
	 */
	public String upload_appender_file1(String group_name, byte[] file_buff,
			String file_ext_name, NameValuePair[] meta_list)
			throws IOException, FastdfsException {
		String parts[] = this.upload_appender_file(group_name, file_buff,
				file_ext_name, meta_list);
		if (parts != null) {
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
					+ parts[1];
	...
	public String upload_appender_file1(String group_name, long file_size,
			UploadCallback callback, String file_ext_name,
			NameValuePair[] meta_list) throws IOException, FastdfsException {
		String parts[] = this.upload_appender_file(group_name, file_size,
				callback, file_ext_name, meta_list);
		if (parts != null) {
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
					+ parts[1];
		} else {
	...
	public String upload_file1(String master_file_id, String prefix_name,
		...
		parts = this.upload_file(parts[0], parts[1], prefix_name, file_size,
				callback, file_ext_name, meta_list);
		if (parts != null) {
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR
					+ parts[1];
	 ...
	 */
	public int append_file1(String appender_file_id, byte[] file_buff,
			int offset, int length) throws IOException, FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(appender_file_id, parts);
		if (this.errno != 0) {
			return this.errno;
	 ...
	 * @return 0 for success, != 0 for error (error no)
	 */
	public int append_file1(String appender_file_id, long file_size,
			UploadCallback callback) throws IOException, FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(appender_file_id, parts);
		if (this.errno != 0) {
			return this.errno;
	 ...
	 * @return 0 for success, != 0 for error (error no)
	 */
	public int modify_file1(String appender_file_id, long file_offset,
		...
		return this
				.modify_file(parts[0], parts[1], file_offset, local_filename);
	}
	 ...
	 */
	public int modify_file1(String appender_file_id, long file_offset,
			long modify_size, UploadCallback callback) throws IOException,
			FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(appender_file_id, parts);
		if (this.errno != 0) {
		...
		return this.modify_file(parts[0], parts[1], file_offset, modify_size,
				callback);
	}
	 ...
	 * @return 0 for success, none zero for fail (error code)
	 */
	public int truncate_file1(String appender_file_id) throws IOException,
			FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(appender_file_id, parts);
		if (this.errno != 0) {
	 ...
	 */
	public byte[] download_file1(String file_id) throws IOException,
			FastdfsException {
	 ...
	 */
	public byte[] download_file1(String file_id, long file_offset,
			long download_bytes) throws IOException, FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0) {
			return null;
		...
		return this.download_file(parts[0], parts[1], file_offset,
				download_bytes);
	}
	 ...
	 * @return 0 success, return none zero errno if fail
	 */
	public int download_file1(String file_id, long file_offset,
			long download_bytes, String local_filename) throws IOException,
			FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0) {
	 ...
	 */
	public int download_file1(String file_id, long file_offset,
			long download_bytes, DownloadCallback callback) throws IOException,
			FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0) {
	 ...
	 */
	public NameValuePair[] get_metadata1(String file_id) throws IOException,
			FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0) {
	 ...
	 */
	public int set_metadata1(String file_id, NameValuePair[] meta_list,
			byte op_flag) throws IOException, FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0) {
			return this.errno;
	 ...
	 */
	public FileInfo query_file_info1(String file_id) throws IOException,
			FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0) {
	 ...
	 * @return FileInfo object for success, return null for fail
	 */
	public FileInfo get_file_info1(String file_id) throws IOException,
			FastdfsException {
		String[] parts = new String[2];
		this.errno = this.split_file_id(file_id, parts);
		if (this.errno != 0) {
