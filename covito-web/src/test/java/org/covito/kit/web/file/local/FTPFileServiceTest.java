...
import org.covito.kit.web.file.support.FtpFileServiceImpl;
...
public class FTPFileServiceTest {
	...
	public static void init() {
		fileService = new FtpFileServiceImpl();
	}
	...
	public void testDelete() throws FileNotFoundException {
		String path = "2014-06-05/da457fc9cefd45cb9a8c7367350d1e81.txt";
